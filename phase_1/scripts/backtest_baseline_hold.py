...
This version introduces decision discipline to reduce turnover and
...
def main() -> None:
    ...
    for symbol, sdf in test.groupby("symbol"):
        ...
        for i in range(len(sdf)):
            ...
            # If currently holding, decrement hold counter
            if days_left > 0:
                days_left -= 1
    ...
    print("Baseline Backtest with Holding Period")
    print("------------------------------------")
